...
//Add a task
router.post('/', (req, res) => {
    const { title, description, deadline, priority, done, createdAt, updatedAt } = req.body;
    const newTask = {
        id: uuidv4(),
        title,
        description,
...
router.put('/:id', (req, res) => {
    ...
    const updatedTask = { ...tasksData.tasks[taskIndex], ...req.body, updatedAt: new Date().toISOString(), id:id };
